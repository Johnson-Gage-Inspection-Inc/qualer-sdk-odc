...
**ODC File:**
[Excel-Qualer-SDK/ClientAssetServiceRecords/ClientAssetServiceRecords_GetAssetServiceRecordsByAssetByAssetId.odc](https://github.com/Johnson-Gage-Inspection-Inc/qualer-sdk-odc/blob/main/Excel-Qualer-SDK/ClientAssetServiceRecords/ClientAssetServiceRecords_GetAssetServiceRecordsByAssetByAssetId.odc)
...
6. Select `ClientAssetServiceRecords_GetAssetServiceRecordsByAssetByAssetId.odc` and click `Open`.
