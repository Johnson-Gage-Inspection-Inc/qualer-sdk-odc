...
**ODC File:**
[Excel-Qualer-SDK/ClientAssets/ClientAssets_GetAssetByAssetId.odc](https://github.com/Johnson-Gage-Inspection-Inc/qualer-sdk-odc/blob/main/Excel-Qualer-SDK/ClientAssets/ClientAssets_GetAssetByAssetId.odc)
...
6. Select `ClientAssets_GetAssetByAssetId.odc` and click `Open`.
