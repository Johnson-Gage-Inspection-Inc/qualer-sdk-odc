let
    Model_accountNumberText = try Excel.CurrentWorkbook(){[Name="Model.accountNumberText"]}[Content]{0} otherwise "",
    Model_companyName = try Excel.CurrentWorkbook(){[Name="Model.companyName"]}[Content]{0} otherwise "",
    Model_take = try Excel.CurrentWorkbook(){[Name="Model.take"]}[Content]{0} otherwise "",
    Model_modifiedAfter = try Excel.CurrentWorkbook(){[Name="Model.modifiedAfter"]}[Content]{0} otherwise "",
